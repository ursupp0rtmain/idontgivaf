  ...
  return (
    <section className="hero">
      ...
      <div className="live-badge">
        ...
        <span>{fmt(visitors)} {visitors === 1 ? 'person is' : 'people are'} wasting time right now</span>
      </div>
      ...
      <div className="global-stats">
        ...
        <span>·</span>
        <span>
          <span className="stat-value">{fmt(clicks)}</span> humiliating catches
        </span>
        <span>·</span>
        <span>
        ...
        <span>·</span>
        <span>
          <span className="stat-value">{fmt(apiCalls)}</span> API calls ignored
        </span>
      </div>

      <p className="scroll-hint">↓ &nbsp; there is nothing down here either &nbsp; ↓</p>
    </section>
  )
}
