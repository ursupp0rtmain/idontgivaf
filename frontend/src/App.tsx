  ...
  return (
    <section className="hero">
      ...
      <div className="live-badge">
        ...
        <span>{fmt(visitors)} {visitors === 1 ? 'soul' : 'souls'} currently wasting time</span>
      </div>
      ...
      <div className="global-stats">
        ...
        <span>·</span>
        <span>
          <span className="stat-value">{fmt(clicks)}</span> embarrassing successes
        </span>
        <span>·</span>
        <span>
        ...
        <span>·</span>
        <span>
          <span className="stat-value">{fmt(apiCalls)}</span> API ignores
        </span>
      </div>

      <p className="scroll-hint">↓ &nbsp; still nothing down here &nbsp; ↓</p>
    </section>
  )
}
