  ...
  return (
    <section className="hero">
      ...
      <div className="live-badge">
        ...
        <span>{fmt(visitors)} {visitors === 1 ? 'soul' : 'souls'} currently wasting their time</span>
      </div>
      ...
      <div className="global-stats">
        ...
        <span>·</span>
        <span>
          <span className="stat-value">{fmt(clicks)}</span> shameful successes
        </span>
        <span>·</span>
        <span>
      ...
      <p className="scroll-hint">↓ &nbsp; there's nothing down here either &nbsp; ↓</p>
    </section>
  )
}
