...
const MILESTONES: { attempts: number; ach: Achievement }[] = [
  ...
  { attempts: 5,  ach: { id: 'persistent', label: 'Persistent',   desc: '5 attempts. Respect. Really.' } },
  { attempts: 20, ach: { id: 'hopeless',   label: 'Hopeless',     desc: '20 attempts. Please get help.' } },
  { attempts: 50, ach: { id: 'legend',     label: 'Legend',        desc: '50 attempts. You are the void.' } },
]

const CLICK_ACH: Achievement = {
  id: 'winner', label: 'Winner', desc: 'You clicked the button. Why though.',
}
